...
{
    #Display add new setting prompt until the user successfully add a new setting.
    loop=y
    while [ $loop = y ]
    do
        ...
        then
            ...
            #If the user enter only the variable value with the "=" 
            ...
            #If the user enter the correct format ABD=abc
            else
                #Check if the user enter the exist variable name    
                checkVariableName=$(grep ${varAdd%=*} config.txt)  
                #The user enter the correct new setting convention 
                #Add new setting to config.txt
                ...
                #If the user enter an exist variable.   
                else
                    echo -e "The variable name of the setting is: ${varAdd%=*} "
                    echo -e "The variable value of the setting is: ${varAdd#*=}"
